...
import '../features/run/countdown_view.dart';
...
/// is the single root screen this phase, so a module-level timer is safe.
...
/// outside Zone B — no `AppBar`, no navigation, no `AnimationController`/
/// curve anywhere (explicitly out of scope this phase).
